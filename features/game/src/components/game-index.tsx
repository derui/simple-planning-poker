...
const styles = {
  ...
  header: clsx("flex-none", "p-2", "text-lg", "font-bold", "rounded-t", "bg-primary-400", "text-secondary1-200"),
  main: {
    root: clsx("flex", "flex-auto", "flex-col", "overflow-y-auto"),
    list: clsx("flex", "flex-auto", "flex-col", "overflow-y-auto"),
    container: clsx(
      "flex",
      "flex-[0_0_auto]",
      "items-center",
    ...
    link: clsx("flex-auto", "h-full", "px-3", "py-4"),
    invitation: clsx("flex", "flex-none", "px-3", "mt-3", "border-b", "border-b-primary-400", "pb-3"),
    invitationToken: clsx(baseInput, "rounded-r-none"),
