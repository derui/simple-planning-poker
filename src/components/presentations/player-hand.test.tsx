...
test("display player card as normal and not opened", async () => {
  render(<PlayerHand userName="user" displayValue="5" state="notSelected" userMode="normal" />);
...
test("display player card as inspector", async () => {
  render(<PlayerHand userName="user" displayValue="5" state="notSelected" userMode="inspector" />);
...
test("selected card", async () => {
  render(<PlayerHand userName="user" displayValue="5" state="handed" userMode="normal" />);
...
test("opened card that user selected", async () => {
  render(<PlayerHand userName="user" displayValue="5" state="result" userMode="normal" />);
